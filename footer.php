  <footer class="footer">
    <div class="container footer__container">
      ...
      <div class="footer__about">
        ...
        <p class="footer__about-text">Аппаратная коррекция фигуры без&nbsp;диет, таблеток и сверхусилий.
          У&nbsp;нас&nbsp;вы найдете
          новейшие методики со 100% результатом.
          Используем современное оборудование.</p>
        <p class="footer__about-address">Мы находимя по адресу: г. Новосибирск, ул. Вокзальная магистраль,16, оф. 205, 2
          эт.</p>
      </div>
      <div class="footer__subscribe">
        <h3 class="footer__subscribe-title">Подписаться на новости</h3>
        <p class="footer__subscribe-text">Чтобы быть в курсе новых акций и&nbsp;новостей нашего салона подпишитесь
          на&nbsp;рассылку.</p>
        <form class="footer__form">
          <input class="footer__input" name="email" type="email" placeholder="Добавьте эл.почту*" required>
          <button class="footer__btn" type="submit">ОК</button>
        </form>
      </div>
      <div class="footer__social social">
        <ul class="social__items">
          <li class="social__item"><a href="http://www.vk.com" class="social__link"><svg width="40" height="40"
                viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_16_137)">
                  <circle cx="20" cy="20" r="20" fill="currentColor" />
                  <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M29.5417 14.9567C29.68 14.5017 29.5417 14.1667 28.8792 14.1667H26.6917C26.135 14.1667 25.8783 14.4559 25.7392 14.7751C25.7392 14.7751 24.6267 17.4384 23.0508 19.1684C22.5408 19.6701 22.3092 19.8292 22.0308 19.8292C21.8917 19.8292 21.6825 19.6701 21.6825 19.2142V14.9567C21.6825 14.4101 21.5292 14.1667 21.0658 14.1667H17.6258C17.2783 14.1667 17.0692 14.4201 17.0692 14.6609C17.0692 15.1784 17.8575 15.2984 17.9383 16.7551V19.9201C17.9383 20.6143 17.8108 20.7401 17.5325 20.7401C16.7908 20.7401 14.9867 18.0642 13.9158 15.0026C13.7083 14.4067 13.4983 14.1667 12.9392 14.1667H10.75C10.125 14.1667 10 14.4559 10 14.7751C10 15.3434 10.7417 18.1667 13.4542 21.9009C15.2625 24.4509 17.8083 25.8334 20.1275 25.8334C21.5183 25.8334 21.69 25.5268 21.69 24.9976V23.0701C21.69 22.4559 21.8217 22.3334 22.2625 22.3334C22.5875 22.3334 23.1433 22.4934 24.4417 23.7226C25.925 25.1801 26.1692 25.8334 27.0042 25.8334H29.1917C29.8167 25.8334 30.13 25.5268 29.95 24.9201C29.7517 24.3168 29.0433 23.4409 28.1042 22.4018C27.5942 21.8101 26.8292 21.1726 26.5967 20.8534C26.2725 20.4442 26.365 20.2617 26.5967 19.8976C26.5967 19.8976 29.2633 16.2092 29.5408 14.9567H29.5417Z"
                    fill="white" />
                </g>
                <defs>
          ...
          <li class="social__item"><a href="http://www.google.com" class="social__link"><svg width="40" height="40"
                viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_16_138)">
                  <circle cx="20" cy="20" r="20" fill="currentColor" />
                  <path
                    d="M27.7942 18.54C27.8967 19.0892 27.9525 19.6633 27.9525 20.2625C27.9525 24.9492 24.8158 28.2817 20.0783 28.2817C19.001 28.282 17.9341 28.07 16.9387 27.6579C15.9432 27.2458 15.0388 26.6415 14.277 25.8797C13.5152 25.1179 12.9109 24.2134 12.4988 23.218C12.0866 22.2226 11.8747 21.1557 11.875 20.0783C11.8747 19.001 12.0866 17.9341 12.4988 16.9387C12.9109 15.9432 13.5152 15.0388 14.277 14.277C15.0388 13.5152 15.9432 12.9109 16.9387 12.4988C17.9341 12.0866 19.001 11.8747 20.0783 11.875C22.2933 11.875 24.1442 12.69 25.5642 14.0133L23.2517 16.3258V16.32C22.3908 15.5 21.2983 15.0792 20.0783 15.0792C17.3717 15.0792 15.1717 17.3658 15.1717 20.0733C15.1717 22.78 17.3717 25.0717 20.0783 25.0717C22.5342 25.0717 24.2058 23.6675 24.5492 21.7392H20.0783V18.54H27.795H27.7942Z"
                    fill="white" />
                </g>
                <defs>
      ...
      <p class="footer__copyright">© 2017-2021 ООО BODY TIME. Все права защищены.</p>
      <p class="footer__confidential">*Политика конфиденциальности</p>
    </div>
  </footer>
  <div class="overlay">
    <div class="modal">
      <div class="modal__container">
        ...
        <form class="modal__form">
          <fieldset class="modal__person">
            <label class="modal__label">
              <input class="modal__input" type="text" name="name" placeholder="Ваше имя" required>
            </label>
            <label class="modal__label">
              <input class="modal__input" type="tel" name="tel" placeholder="+7 (953) 812-12-77"
                pattern="+7[0-9]{3}-[0-9]{3}-[0-9]{4}" required>
            </label>

            <div class="modal__checkbox checkbox">
              <input class="checkbox__input" type="checkbox" name="checkbox" id="checkbox" required>
          ...
          <button class="modal__order" type="submit">Заказать звонок</button>
        </form>
